...
DELIMITER $
CREATE TRIGGER tr_log_deletion_cli AFTER DELETE ON tbl_clientes
	FOR EACH ROW
    BEGIN
...
DELIMITER $
CREATE TRIGGER tr_log_deletion_end AFTER DELETE ON tbl_enderecos
	FOR EACH ROW
    BEGIN
...
DELIMITER $
CREATE TRIGGER tr_log_deletion_dis AFTER DELETE ON tbl_dispositivos
	FOR EACH ROW
    BEGIN
